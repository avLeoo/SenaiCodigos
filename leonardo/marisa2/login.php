...
<body>
    ...
    <div class="login">
        <form action="" method="" class="formulario">
            ...
            <input type="text" name="login" placeholder="Informe seu E-mail ou CPF" class="inp_login">


            <label>Senha *</label>
            <input type="password" name="senha" placeholder="Informe senha" class="inp_login">
