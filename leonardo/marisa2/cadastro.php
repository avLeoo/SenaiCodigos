            ...
            <div class="cadastro_box1">
                ...
                <form action="" method="" class="form1">
                    ...
                    <div class="box_form">
                        <div class="box_form_nasc">
                            ...
                            <input type="text" name="dtnasc" placeholder="00/00/0000" class="inp_cad2" id="dtnasc_id" />
                        </div>
                    ...
                    <div class="box_form">
                        <div class="box_form_ddd1">
                            <b>DDD *</b>
                            <input type="text" name="ddd1" placeholder="(00)" class="inp_cad4" id="dddcel_id"/>
                        </div>
                        <div class="box_form_celular">
                            <b>Celular *</b>
                            <input type="text" name="celular" placeholder="0000 - 0000" class="inp_cad5" id="ncel_id"/>
                        </div>
                        <div class="box_form_ddd2">
                            <b>DDD *</b>
                            <input type="text" name="ddd2" placeholder="(00)" class="inp_cad4" id="dddtel_id"/>
                        </div>
                        <div class="box_form_tel">
                            <b>Telefone *</b>
                            <input type="text" name="tel" placeholder="0000 - 0000" class="inp_cad5" id="ntel_id"/>
                        </div>
                    </div>
                ...
                <form action="" method="" class="form1_1">
                    ...
                    <div class="box_form">
                        <div class="box_form_ddd1">
                            <b>DDD *</b>
                            <input type="text" name="ddd1_1" placeholder="(00)" class="inp_cad4" id="dddcel_pj_id"/>
                        </div>
                        <div class="box_form_celular">
                            <b>Celular *</b>
                            <input type="text" name="celular1" placeholder="0000 - 0000" class="inp_cad5" id="ncel_pj_id"/>
                        </div>
                        <div class="box_form_ddd2">
                            <b>DDD *</b>
                            <input type="text" name="ddd2_1" placeholder="(00)" class="inp_cad4" id="dddtel_pj_id"/>
                        </div>
                        <div class="box_form_tel">
                            <b>Telefone *</b>
                            <input type="text" name="tel1" placeholder="0000 - 0000" class="inp_cad5" id="ntel_pj_id"/>
                        </div>
                    </div>
